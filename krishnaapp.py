...
# app.config["MONGO_URI"] = "mongodb://localhost:27017/krishnadb"
# mongo = PyMongo(app)
# mysql = MySQL(app)
...
def  product_avail():
    ...
    DATA=[{"name":"Paracetamol","company":"Aristorate","type":"capsules","quant":"1","quantity":"1", "desc":"Anti-amalgamation","mrp":"58.69"}]
...
def invoice_generation():
    ...
    DATA["items"].append({"name":"Paracetamol","stk_id":"123","quant":45,"mrp":30})
    DATA["txn_id"]=int(123)
...
def stock_purchase():
    ...
    DATA[0].append({"id":"sel1","name":"AMIT ENTERPRISE"+" / "+"DONAR"})
    DATA[1].append({"code":"prod1","name":"Paracitamol","quant":3,"mrp":30})
...
def new_stockist_list():
    ...
    DATA.append({"name":"Name","phone":9878765456,"address":"DBG","submitted_on":"25/06/2020"})
